...
def compute_target(default_boxes, gt_boxes, gt_labels, iou_threshold=0.5):
    ...
    #print("\n best_gt_idx_1 = {}".format(best_gt_idx))
    #print("\n best_gt_idx_1 = ", best_gt_idx)
    ...
    #print("\n best_gt_idx_2 = {}".format(best_gt_idx))
    #print("\n best_gt_idx_2 = ", best_gt_idx)
