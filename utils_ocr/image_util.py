...
from config_ocr import constants as const
from config_ocr.constants import FJoin
from model.detect_text.evaluate import get_annotation
from utils_ocr.dir_util import dir_explore
...
class ImageVisualizer(object):
    ...
    def save_image(self, img, boxes, labels, scores):
...
def check_blur(image, blur_threshold=100):
    ...
    if cv2.Laplacian(gray, cv2.CV_64F) is None:
        ...
        print("Laplacian count = {}".format(count))
