...
BASE_DIR = os.path.expanduser("./ckpt_saved_model/paddleocr")
...
class PaddleOCR(predict_system.TextSystem):
    def __init__(self, **kwargs):
        ...
        params.det_model_dir, det_url = confirm_model_dir_url(params.det_model_dir,
                                                              os.path.join(BASE_DIR, 'ocr', 'det', det_lang),
                                                              model_urls['det'][det_lang])
        params.rec_model_dir, rec_url = confirm_model_dir_url(params.rec_model_dir,
                                                              os.path.join(BASE_DIR, 'ocr', 'rec', lang),
                                                              model_urls['rec'][lang]['url'])
        params.cls_model_dir, cls_url = confirm_model_dir_url(params.cls_model_dir,
                                                              os.path.join(BASE_DIR, 'ocr', 'cls'),
                                                              model_urls['cls'])
